...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justiify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-secondaryColor p-3 flex flex-0 7 w-full">
          <div className="flex justify-center items-center flex-col border-2 border-doted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              <label>
                <div className="flex flex-col items-center justify-cener h-4">
